...
const projects = [
  {
    ...
    tags: ["React.js", "TypeScript", "Node.js", "Express.js", "Firebase", "Cloudinary", "Cloudflare", "Razorpay", "Vite"],
    ...
    solution: "Developed a full-stack career development SaaS platform connecting students, mentors, recruiters, alumni, and educational institutions through a unified role-based ecosystem.",
    features: [
      "Career guidance, internship and job portal",
      "Unified role-based ecosystem for students, mentors, recruiters, and alumni",
      "Mentor-student networking pathways",
      "Scholarship discovery and event management portals",
      "Personalized user dashboards with fine-grained access control"
    ],
    architecture: "Vite Client (React.js + TS) -> Express.js REST API -> Firebase. Cloudflare Edge Caching mitigates query costs, while Cloudinary handles dynamic media conversion.",
    ...
    businessImpact: "Created a unified platform for professional networking. Reduced mentorship match lag by 60% and successfully placed 20+ candidates in initial testing.",
    ...
    github: "https://github.com/FaizulRahman786/MB.git",
  },
  {
    id: "anamika-saas",
    title: "Anamika SaaS Platform",
    ...
    solution: "Developed a multi-tenant SaaS platform for restaurants and sweet shops isolating store locations and automating reservation workflows.",
    features: [
      "Multi-tenant SaaS architecture for store isolation",
      "Dynamic admin dashboard and secure authentication",
      "Order, reservation, and sweet shop review panels",
      "Gallery and content management system",
      "Cloudinary integration, RBAC, and responsive UI"
    ],
    architecture: "React.js + TS client, Node.js/Express.js API, Firebase Database, Clerk API for auth, and Cloudflare CDN caching for static pages.",
